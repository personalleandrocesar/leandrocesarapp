...
const Users = await useFetch(`https://api-hjsxsumlfq-uc.a.run.app/users/${route.params.id}`);
const UsersTrainnig = await useFetch(`https://api-hjsxsumlfq-uc.a.run.app/users/${route.params.id}/treino`);
...
async function submitTreino() {
    try {
        const response = await fetch(`https://api-hjsxsumlfq-uc.a.run.app/user/${route.params.id}/treinos`, {
            method: 'post',
            headers: {
...
const dataConf = await useFetch(`https://api-hjsxsumlfq-uc.a.run.app/users/${route.params.id}`)
