export default defineEventHandler((event) => {
  return [
    // Série Atual
    { num: 'Exercício 1', nome: 'Extensora', sets: 3, reps: '7 c/3" + 7', rest: '40"', grupo: '', obs: 'Fazer 7 repetições segurando 3 segundos a cada repetição e + 7 direto no final.', img: 'https://api.nexwod.app/exe/extensora.gif'},
    ...
    { num: 'Exercício 11', nome: 'Panturrilha sentada no aparelho', sets: 3, reps: '10 +10" +10', rest: '40"', grupo: '', obs: '', img: 'https://api.nexwod.app/exe/panturrilhaSentado.gif'},
