export default defineEventHandler((event) => {
  return [
    ...
    { num: 'Exercício 4', nome: 'Agachamento Smith', sets: 4, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://api.nexwod.app/exe/squatSmith.gif'},
    { num: 'Exercício 5', nome: 'Adutora', sets: 4, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://api.nexwod.app/exe/adutora.gif'},
    ...
    { num: 'Exercício 10', nome: 'Tríceps corda na polia alta', sets: 3, reps: '12 + 12', rest: '50"', grupo: '', obs: 'Fazer rest-pause: Fazer 12 repetições, descansa 10": + 12 repetições.', img: 'https://api.nexwod.app/exe/tricepsCorda.gif' },
